  ...
  return (
    <div className="flex h-screen bg-gray-50 overflow-hidden">
      ...
      <div className={`
        ...
        w-64 bg-white shadow-xl lg:shadow-lg transition-transform duration-300 ease-in-out
        flex flex-col h-full
      `}>
        {/* Logo/Header */}
        <div className="flex items-center justify-between p-4 border-b bg-blue-600 text-white lg:bg-white lg:text-gray-800">
          <h1 className="text-xl font-bold">Leave System</h1>
          <Button
            variant="ghost"
            size="sm"
            className="lg:hidden text-white hover:bg-blue-700 lg:text-gray-800"
            onClick={() => setIsSidebarOpen(false)}
          >
            <X className="h-5 w-5" />
          </Button>
      ...
      <div className="flex-1 flex flex-col overflow-hidden lg:ml-0">
        {/* Top Bar */}
        <header className="bg-white shadow-sm border-b lg:border-l">
